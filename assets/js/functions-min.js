    ...
    $(document).ready(function () {
                ...
                $(".slider2").animate({ opacity: 0 }, 400),
                    setTimeout(function () {
                        t.hasClass("slider2--next")
                            ? a - 1 > i && a - 1 > s && a - 1 > o
                                ? (l.removeClass("slider2--item-left").next().addClass("slider2--item-left"),
                                  c.removeClass("slider2--item-center").next().addClass("slider2--item-center"),
                                  h.removeClass("slider2--item-right").next().addClass("slider2--item-right"))
                                : i === a - 1
                                ? (u.removeClass("slider2--item-left").first().addClass("slider2--item-left"),
                                  c.removeClass("slider2--item-center").next().addClass("slider2--item-center"),
                                  h.removeClass("slider2--item-right").next().addClass("slider2--item-right"))
                                : s === a - 1
                                ? (l.removeClass("slider2--item-left").next().addClass("slider2--item-left"),
                                  u.removeClass("slider2--item-center").first().addClass("slider2--item-center"),
                                  h.removeClass("slider2--item-right").next().addClass("slider2--item-right"))
                                : (l.removeClass("slider2--item-left").next().addClass("slider2--item-left"),
                                  c.removeClass("slider2--item-center").next().addClass("slider2--item-center"),
                                  u.removeClass("slider2--item-right").first().addClass("slider2--item-right"))
                            : 0 !== i && 0 !== s && 0 !== o
                            ? (l.removeClass("slider2--item-left").prev().addClass("slider2--item-left"),
                              c.removeClass("slider2--item-center").prev().addClass("slider2--item-center"),
                              h.removeClass("slider2--item-right").prev().addClass("slider2--item-right"))
                            : 0 === i
                            ? (u.removeClass("slider2--item-left").last().addClass("slider2--item-left"),
                              c.removeClass("slider2--item-center").prev().addClass("slider2--item-center"),
                              h.removeClass("slider2--item-right").prev().addClass("slider2--item-right"))
                            : 0 === s
                            ? (l.removeClass("slider2--item-left").prev().addClass("slider2--item-left"),
                              u.removeClass("slider2--item-center").last().addClass("slider2--item-center"),
                              h.removeClass("slider2--item-right").prev().addClass("slider2--item-right"))
                            : (l.removeClass("slider2--item-left").prev().addClass("slider2--item-left"),
                              c.removeClass("slider2--item-center").prev().addClass("slider2--item-center"),
                              u.removeClass("slider2--item-right").last().addClass("slider2--item-right"));
                    }, 400),
        ...
        function s3() {
            $(".slider3--prev, .slider3--next").click(function () {
                var t = $(this),
                    e = $(".slider3").find(".slider3--item-left"),
                    i = $(".slider3").children().index(e),
                    n = $(".slider3").find(".slider3--item-center"),
                    s = $(".slider3").children().index(n),
                    r = $(".slider3").find(".slider3--item-right"),
                    o = $(".slider3").children().index(r),
                    a = $(".slider3").children().length,
                    l = $(".slider3--item-left"),
                    c = $(".slider3--item-center"),
                    h = $(".slider3--item-right"),
                    u = $(".slider3--item");
                $(".slider3").animate({ opacity: 0 }, 400),
                    setTimeout(function () {
                        t.hasClass("slider3--next")
                            ? a - 1 > i && a - 1 > s && a - 1 > o
                                ? (l.removeClass("slider3--item-left").next().addClass("slider3--item-left"),
                                  c.removeClass("slider3--item-center").next().addClass("slider3--item-center"),
                                  h.removeClass("slider3--item-right").next().addClass("slider3--item-right"))
                                : i === a - 1
                                ? (u.removeClass("slider3--item-left").first().addClass("slider3--item-left"),
                                  c.removeClass("slider3--item-center").next().addClass("slider3--item-center"),
                                  h.removeClass("slider3--item-right").next().addClass("slider3--item-right"))
                                : s === a - 1
                                ? (l.removeClass("slider3--item-left").next().addClass("slider3--item-left"),
                                  u.removeClass("slider3--item-center").first().addClass("slider3--item-center"),
                                  h.removeClass("slider3--item-right").next().addClass("slider3--item-right"))
                                : (l.removeClass("slider3--item-left").next().addClass("slider3--item-left"),
                                  c.removeClass("slider3--item-center").next().addClass("slider3--item-center"),
                                  u.removeClass("slider3--item-right").first().addClass("slider3--item-right"))
                            : 0 !== i && 0 !== s && 0 !== o
                            ? (l.removeClass("slider3--item-left").prev().addClass("slider3--item-left"),
                              c.removeClass("slider3--item-center").prev().addClass("slider3--item-center"),
                              h.removeClass("slider3--item-right").prev().addClass("slider3--item-right"))
                            : 0 === i
                            ? (u.removeClass("slider3--item-left").last().addClass("slider3--item-left"),
                              c.removeClass("slider3--item-center").prev().addClass("slider3--item-center"),
                              h.removeClass("slider3--item-right").prev().addClass("slider3--item-right"))
                            : 0 === s
                            ? (l.removeClass("slider3--item-left").prev().addClass("slider3--item-left"),
                              u.removeClass("slider3--item-center").last().addClass("slider3--item-center"),
                              h.removeClass("slider3--item-right").prev().addClass("slider3--item-right"))
                            : (l.removeClass("slider3--item-left").prev().addClass("slider3--item-left"),
                              c.removeClass("slider3--item-center").prev().addClass("slider3--item-center"),
                              u.removeClass("slider3--item-right").last().addClass("slider3--item-right"));
                    }, 400),
